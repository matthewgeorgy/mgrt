...
CornellBunny  :: proc(World : ^world, Camera : ^camera, ImageWidth, ImageHeight : i32)
{
	...
	AddMaterial(World, lambertian{v3{0.05, 0.05, 0.85}})
...
GlassSuzanne :: proc(World : ^world, Camera : ^camera, ImageWidth, ImageHeight : i32)
{
	...
	// World
	AddMaterial(World, lambertian{v3{0.2, 0.2, 0.2}})
	AddMaterial(World, lambertian{v3{0.8, 0.2, 0.2}})
	AddMaterial(World, lambertian{v3{0.2, 0.6, 0.8}})
	AddMaterial(World, light{v3{1, 1, 1}})
	AddMaterial(World, dielectric{1.33})
